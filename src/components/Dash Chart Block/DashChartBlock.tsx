import { UseTasks, TaskData } from "@/features/Tasks/context/TaskContext";
...
const DashChart = () => {
    ...
    const getTasksCompletedEachMonth = (tasks: TaskData[]) => {
        // Filter completed tasks and get current date
    ...
    return (
        <div className="dashboard-chart">
            ...
            <div className="dashboard-chart__header">
                <h2 className="dashboard-chart__title">Total tasks</h2>
            </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
                <LineChart
                    ...
                    // height={ 200 }
                    data={ chartData }
                    margin={ { top: 25, right: 50, left: -10, bottom: 70 } }
                >
                    <XAxis
                        dataKey="name"
                        tick={ { fontSize: 12 } }
