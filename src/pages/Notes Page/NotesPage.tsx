                                ...
                                <div className="note__header">
                                    ...
                                    <div className="note__header-items">
                                        <div className="note__header-item">
                                            ...
                                            <p className="note__header-text">Folder</p>
                                        </div>
                                    ...
                                    <div className="note__header-actions">
                                        ...
                                        <button className="note__header-button note__header-button--fav">
                                        ...
                                        <button className="note__header-button note__header-button--delete" onClick={(event) => { event.stopPropagation(); deleteNote(note.id); }}>
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
