...
const Dashboard = () => {
   ...
   const [selectedDateToFilterBy, setSelectedDateToFilterBy] = useState<Date | null>(null);
   ...
   const tasksDueOnDate = tasks.filter(task => {
      ...
      const taskDueDate = task.dueDate instanceof Timestamp
         ? task.dueDate.toDate()
         : task.dueDate;
               ...
               <section className="dashboard-grid__4">
                  ...
                  <div className="dashboard-results">
                     ...
                     <ul className="dashboard-results__list">
                        { (selectedDateToFilterBy ? tasksDueOnDate : tasks).map((task) => (
                           <TaskCard task={ task } key={ task.id } />
                        )) }
                     </ul>
