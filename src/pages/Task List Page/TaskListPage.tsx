...
const TaskListPage = () => {
   ...
   const handlecreateTask = (event: React.FormEvent<HTMLFormElement>) => {
      ...
      createTask(taskTitle, taskContent, taskDueDate, taskLabel, undefined, undefined);
      setTaskTitle("");
      setTaskContent("");
      setTaskDueDate(null);
      setTaskLabel("");
      ...
      <div className="page-wrapper">
         ...
         <div className="task-list-page">
            ...
            <>
               ...
               <p className="task-list-page__subtitle">All your tasks in one place</p>
            ...
            <div className="task-list-page__actions">
               ...
               <button className="task-list-page__actions-button" type="button" onClick={ openModal }>
                  <Plus />
               </button>
